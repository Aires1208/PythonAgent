...
class zipkin_span(object):
    ...
    def __init__(
        ...
        :param transport_handler: Callback function that takes a message parameter and handles logging it
        ...
        :param add_logging_annotation: Whether to add a 'start_logging' annotation when py_zipkin starts logging spans
    ...
    def start(self, start_timestamp):
        ...
        if self.perform_logging:
            ...
            self.logging_context.start(start_timestamp)
            return self
        else:
    ...
    def stop(self, _exc_type=None, _exc_value=None, _exc_traceback=None, start_timestamp=None, end_timestamp=None):
        ...
        if self.logging_context:
            # FIXME sunyan
            self.logging_context.stop(end_timestamp)
            self.logging_context = None
            return
