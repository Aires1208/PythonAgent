...
class Naming(Settings):
    ...
    def __init__(self, rules=None):
        ...
        self.match_type = {
            "1": self.match_equal,
            "2": self.match_start_with,
            "3": self.match_end_with,
            "4": self.match_include,
            "5": self.match_regex,
            "0": self.any_value
        }
...
# server configuration & some limitation about the data set the default value for it.
...
_settings.action_tracer.slow_sql_threshold = 0
_settings.action_tracer.log_sql = False
_settings.action_tracer.explain_enabled = True
_settings.action_tracer.explain_threshold = 0  # 500ms
