...
from ssa.armoury.trigger.wsgi_entrance import wsgi_application_wrapper
from ssa.armoury.ammunition.function_tracker import wrap_function_trace
from ssa.armoury.ammunition.flask_tracker import add_url_rule_wrapper, handle_exception_wrapper
from ssa.armoury.ammunition.flask_tracker import wrap_register_error, wrap_func_with_request
...
def detect_wsgi_entrance(module):
    print "==>detect_wsgi_entrance begin"
    version = 'xx'
    try:
        import flask
    ...
    print "<==detect_wsgi_entrance end"


def detect_app_entrance(module):
    print "==>detect_app_entrance begin"
