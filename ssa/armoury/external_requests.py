...
from ssa.armoury.ammunition.external_tracker import wrap_external_trace, process_cross_trace, parse_parameters
from ssa.armoury.ammunition.external_tracker import MALFORMED_URL_ERROR_CODE
from ssa.armoury.ammunition.external_tracker import CONNECT_EXCEPTION_ERROR_CODE, TIMEOUT_EXCEPTION_ERROR_CODE
from ssa.armoury.ammunition.external_tracker import CLIENT_PROTOCOL_ERROR_CODE, ILLEGAL_RESPONSE_ERROR_CODE
from ssa.armoury.ammunition.external_tracker import OTHER_ERROR_CODE
...
def detect_requests_sessions(module):
    ...
    def parse_params(method, url, *args, **kwargs):
        ...
        if 'headers' in _kwargs:
            print("1. headers in _kwargs")
            _kwargs['headers'] = process_cross_trace(_kwargs['headers'])
        else:
            print("2. headers not in _kwargs")
