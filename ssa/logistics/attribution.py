...
TracedExternalError = namedtuple("TracedExternalError", ['error_filter_key', "trace_data", 'tracker_type', "status_code"])

RootNode = namedtuple('RootNode', ['start_time', 'request_uri', 'duration', 'name', 'trace_data'])
TraceNode = namedtuple('TraceNode', ['start_time', 'end_time', 'metric_name', 'call_url', 'call_count', 'class_name', 'method_name', 'params', 'children'])
