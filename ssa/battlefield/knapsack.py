...
class Knapsack(object):
    ...
    def singleton_instance():
        ...
        with Knapsack._instance_lock:
            if not Knapsack._instance:
                ...
                console.info('Createing instance of tracker Knapsack in process %d.', os.getpid())
    ...
    def get_active_threads(self):
        for thread_id, frame in sys._current_frames().items():
            ...
            if tracker is not None:
                ...
                if active_thread is not None and active_thread.getName().startswith('SSA-'):
    ...
    def drop_tracker(self, tracker):
        ...
        if thread_id not in self._cache:
            # FIXME
            raise RuntimeError('no active tracker')
